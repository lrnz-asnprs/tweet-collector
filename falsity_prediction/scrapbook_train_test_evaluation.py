...
DRIVER_CONTINUOUS_USER_FEATURES.remove('ideology_score')
...
report = pd.DataFrame(cl_report).transpose().round(2)
...
print(report)
# report.to_latex('classification_results_random_forest.tex')
...
fig.savefig('feature_importance_analysis.pdf', bbox_inches='tight')
